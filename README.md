...
---
## 🧩 Clean Data – Join, Convert and Distribute Data for Dimension Tables

### 🔹 Output of Join Between `Final_Dataverse` and `Correct_Name`
...
### 🔹 Multicast – Distribute Clean Data
...
During load, the destination table is created with only the required columns and mapped accordingly.

Final data is stored into the table:

```
Dim_Customer_Table
```

This table contains clean, standardized and dimension-ready customer data generated from the fuzz-corrected and transformed dataset.
